...
sys.path.append("..")
from APILib.rbklib import rbklib, normalize_theta
...
def setup_module():
    ...
    with open("config.json", "r") as f:
        ...
        jack_load = body["JackLoad"]
        jack_unload = body["JackUnload"]
    return open_ip, model, s_id, task_id, charger_name, jack_load, jack_unload


ip, model_name, source_id, task, charger, jack_load, jack_unload = setup_module()
