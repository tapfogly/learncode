...
class rbklib:
    ...
    def robot_status_info_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人信息
        """
        return self.request(1000)

    def robot_status_run_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人的运行状态信息(如运行时间、里程等)
        """
        return self.request(1002)

    def robot_status_loc_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人在世界坐标系中的坐标
        """
        return self.request(1004)

    def robot_status_speed_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人速度
        """
        return self.request(1005)

    def robot_status_block_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人的被阻挡状态
        """
        return self.request(1006)

    def robot_status_battery_req(self, simple: bool = False) -> tuple[tuple, bytes]:
        """
        查询机器人电池状态
    ...
    def robot_status_laser_req(self, return_beams3D: bool = False) -> tuple[tuple, bytes]:
        """
        查询机器人激光点云数据
    ...
    def robot_status_path_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人自由导航路径数据\n
    ...
    def robot_status_area_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人当前所在的区域信息
        """
        return self.request(1011)

    def robot_status_emergency_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人急停按钮的状态
        """
        return self.request(1012)

    def robot_status_io_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人 I/O 数据
        """
        return self.request(1013)

    def robot_status_imu_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人 IMU 数据
        """
        return self.request(1014)

    def robot_status_rfid_req(self) -> tuple[tuple, bytes]:
        """
        查询 RFID 数据
        """
        return self.request(1015)

    def robot_status_ultrasonic_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人的超声传感器数据
        """
        return self.request(1016)

    def robot_status_pgv_req(self) -> tuple[tuple, bytes]:
        """
        查询二维码数据(PGV)数据
        """
        return self.request(1017)

    def robot_status_encoder_req(self) -> tuple[tuple, bytes]:
        """
        查询编码器脉冲值
        """
        return self.request(1018)

    def robot_status_task_req(self, simple: bool = False) -> tuple[tuple, bytes]:
        """
    ...
    def robot_status_reloc_req(self) -> tuple[tuple, bytes]:
        """
         查询机器人当前的定位状态
        """
        return self.request(1021)

    def robot_status_loadmap_req(self) -> tuple[tuple, bytes]:
        """
         查询机器人当前地图载入状态
        """
        return self.request(1022)

    def robot_status_slam_req(self) -> tuple[tuple, bytes]:
        """
         查询机器人当前的扫图状态
        """
        return self.request(1025)

    def robot_status_jack_req(self) -> tuple[tuple, bytes]:
        """
         查询顶升机构状态\n
         仅对选配顶升机构的机器人有意义\n
    ...
    def robot_status_fork_req(self) -> tuple[tuple, bytes]:
        """
         查询货叉(叉车)状态\n
         仅对有货叉的机器人有意义, 如叉车等
        """
    ...
    def robot_status_roller_req(self) -> tuple[tuple, bytes]:
        """
         查询辊筒(皮带)状态\n
         仅对选配有辊筒或皮带的机器人有意义
        """
    ...
    def robot_status_motor_req(self, motor_names: list[str] = None) -> tuple[tuple, bytes]:
        """
        查询电机状态信息
    ...
    def robot_status_alarm_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人当前的报警状态
        """
        return self.request(1050)

    def robot_status_current_lock_req(self) -> tuple[tuple, bytes]:
        """
        查询当前控制权所有者
        """
        return self.request(1060)

    def robot_status_all1_req(self, keys: list[str] = None, return_laser: bool = True,
                              return_beams3D: bool = False) -> tuple[tuple, bytes]:
        """
        查询批量数据1\n
    ...
    def robot_status_all2_req(self, return_laser: bool = True) -> tuple[tuple, bytes]:
        """
        查询批量数据2\n
    ...
    def robot_status_all3_req(self) -> tuple[tuple, bytes]:
        """
        查询批量数据3\n
    ...
    def robot_status_task_status_package_req(self, task_ids: list[str] = None) -> tuple[tuple, bytes]:
        """
        查询机器人任务状态
    ...
    def robot_status_map_req(self) -> tuple[tuple, bytes]:
        """
        查询机器人载入的地图以及储存的地图
        """
        return self.request(1300)

    def robot_status_station(self) -> tuple[tuple, bytes]:
        """
        查询机器人当前载入地图中的站点信息\n
    ...
    def robot_status_mapmd5_req(self, map_names: list[str]) -> tuple[tuple, bytes]:
        """
        查询指定地图列表的MD5值
    ...
    def robot_status_params_req(self, plugin: str = "", param: str = "") -> tuple[tuple, bytes]:
        """
        查询机器人参数信息
    ...
    def robot_status_model_req(self) -> tuple[tuple, bytes]:
        """
        下载机器人模型文件\n
    ...
    def robot_status_canframe_req(self) -> tuple[tuple, bytes]:
        """
        查询驱动器参数
        """
        return self.request(1750)

    def robot_status_gnsscheck_req(self, id: str = "") -> tuple[tuple, bytes]:
        """
        查询机器人 GNSS 连接状态
    ...
    def robot_status_downloadfile_req(self, type: str = "", file_path: str = "") -> tuple[tuple[int], bytes]:
        """
        下载机器人文件
    ...
    def robot_status_removefile_req(self, type: str = "", file_path: str = "") -> tuple[tuple, bytes]:
        """
        删除机器人文件
    ...
    def robot_status_submaps_list_req(self, map_name: str) -> tuple[tuple, bytes]:
        """
        查询机器人子地图
    ...
    def robot_control_stop_req(self) -> tuple[tuple, bytes]:
        """
        停止开环运动
        """
    ...
    def robot_control_reloc_req(self, x: float = None, y: float = None, angle: float = None, length: float = 0,
                                home: bool = False) -> tuple[tuple, bytes]:
        """
         重定位
    ...
    def robot_control_comfirmloc_req(self) -> tuple[tuple, bytes]:
        """
        确认定位正确
        """
        return self.request(2003)

    def robot_control_cancelreloc_req(self) -> tuple[tuple, bytes]:
        """
        取消重定位\n
    ...
    def robot_control_motion_req(self, vx: float = 0, vy: float = 0, w: float = 0, steer: float = None,
                                 reel_steer: float = None, duration: float = None) -> tuple[tuple, bytes]:
        """
        开环运动
    ...
    def robot_control_loadmap_req(self, map_name: str) -> tuple[tuple, bytes]:
        """
        切换载入的地图
    ...
    def robot_control_clearmotorencoder_req(self, name: str) -> tuple[tuple, bytes]:
        """
        对指定电机标零
    ...
    def robot_task_pause_req(self) -> tuple[tuple, bytes]:
        """
        暂停当前导航
        """
        return self.request(3001)

    def robot_task_resume_req(self) -> tuple[tuple, bytes]:
        """
        继续当前导航
        """
        return self.request(3002)

    def robot_task_cancel_req(self) -> tuple[tuple, bytes]:
        """
        取消当前导航
        """
        return self.request(3003)

    def robot_task_gotarget_req(self, **kwargs) -> tuple[tuple, bytes]:
        """
        路径导航\n
    ...
    def robot_task_gotarget2_req(self, **kwargs) -> tuple[tuple, bytes]:
        """
        路径导航\n
    ...
    def robot_task_target_path_req(self, id: str) -> tuple[tuple, bytes]:
        """
        获取路径导航的路径
    ...
    def robot_task_translate_req(self, dist: float, vx: float = None, vy: float = None, mode: int = None) -> tuple[
        tuple, bytes]:
        """
        平动，以固定速度直线运动固定距离\n
    ...
    def robot_task_turn_req(self, angle: float, vw: float, mode: int = None) -> tuple[tuple, bytes]:
        """
        转动, 以固定角速度旋转固定角度\n
    ...
    def robot_task_spin_req(self, increase_spin_angle: float = None, robot_spin_angle: int = None,
                            global_spin_angle: int = None, spin_direction: int = None) -> tuple[tuple, bytes]:
        """
        对托盘进行旋转\n
    ...
    def robot_task_circular_req(self, rot_radius: float = None, rot_degree: float = None,
                                rot_speed: float = None, mode: int = None) -> tuple[tuple, bytes]:
        """
        圆弧运动\n
        注意: 3055(平动), 3056(转动), 3057, 3058 不能同时进行
    ...
    def robot_task_gotargetlist_req(self, **kwargs) -> tuple[tuple, bytes]:
        """
        指定路径导航\n
    ...
    def robot_task_cleartargetlist_req(self) -> tuple[tuple, bytes]:
        """
        清除指定导航路径\n
    ...
    def robot_tasklist_status_req(self, with_robot_status: bool = None, task_list_name: str = None) -> tuple[
        tuple, bytes]:
        d = {}
    ...
    def robot_tasklist_name_req(self, name: str) -> tuple[tuple, bytes]:
        """
        执行预存任务链
    ...
    def robot_config_require_req(self) -> tuple[tuple, bytes]:
        """
        回收控制权\n
    ...
    def robot_config_release_req(self) -> tuple[tuple, bytes]:
        """
        释放控制权\n
    ...
    def robot_config_src_require_req(self) -> tuple[tuple, bytes]:
        """
        SRC 控制模式\n
    ...
    def robot_config_src_release_req(self) -> tuple[tuple, bytes]:
        """
        SRC 监听模式\n
    ...
    def robot_config_lock_req(self, nick_name: str) -> tuple[tuple, bytes]:
        """
        抢占控制权
    ...
    def robot_config_unlock_req(self) -> tuple[tuple, bytes]:
        """
        释放控制权\n
    ...
    def robot_config_clearallerrors_req(self) -> tuple[tuple, bytes]:
        """
        清除机器人当前所有报错
        """
        return self.request(4009)

    def robot_config_uploadmap_req(self, mapPath: str) -> tuple[tuple, bytes]:
        """
        上传地图到机器人
    ...
    def robot_config_downloadmap_req(self, map_name: str) -> tuple[tuple[int], bytes]:
        """
        从机器人下载地图
    ...
    def robot_config_removemap_req(self, map_name: str) -> tuple[tuple, bytes]:
        """
        删除机器人上的地图
    ...
    def robot_config_push_req(self, interval: int = None, included_fields: list[str] = None,
                              excluded_fields: list[str] = None, persistent: bool = None) -> tuple[tuple, bytes]:
        """
        配置推送端口 19301\n
    ...
    def robot_config_setparams_req(self, **kwargs) -> tuple[tuple, bytes]:
        """
        临时修改机器人参数\n
    ...
    def robot_config_saveparams_req(self, **kwargs) -> tuple[tuple, bytes]:
        """
        永久修改机器人参数
    ...
    def robot_config_reloadparams_req(self, params: list = None) -> tuple[tuple, bytes]:
        """
        恢复机器人参数为默认值\n
    ...
    def robot_config_ultrasonic_req(self, id: int, valid: bool) -> tuple[tuple, bytes]:
        """
        配置超声\n
        用于配置某个 ID 的超声是否启用
        :param id: 	超声的 ID
    ...
    def robot_config_DI_req(self, id: int, valid: bool) -> tuple[tuple, bytes]:
        """
        配置 DI\n
        用于配置某个 id 的 DI 是否启用
    ...
    def robot_config_motor_calib_req(self, motor_name: str) -> tuple[tuple, bytes]:
        """
        电机标零
    ...
    def robot_config_motor_clear_fault_req(self, motor_name: str) -> tuple[tuple, bytes]:
        """
        电机清错
    ...
    def robot_config_model_req(self, modelPath: str) -> tuple[tuple, bytes]:
        """
        上传模型文件到机器人
    ...
    def robot_config_addobstacle_req(self, name: str, x1: float, y1: float, x2: float, y2: float,
                                     x3: float, y3: float, x4: float, y4: float) -> tuple[tuple, bytes]:
        """
        插入动态障碍物(机器人坐标系)\n
    ...
    def robot_config_removeobstacle_req(self, name: str = None) -> tuple[tuple, bytes]:
        """
        移除动态障碍物\n
    ...
    def robot_config_clear_goodsshape_req(self) -> tuple[tuple, bytes]:
        """
        清除货架描述文件
        """
        return self.request(4356)

    def robot_config_set_shelfshape_req(self, object_path: str) -> tuple[tuple, bytes]:
        """
        设置当前使用的货架描述文件
    ...
    def robot_config_reset_gnss_req(self, id: str = "") -> tuple[tuple, bytes]:
        """
        重置 GNSS 硬件配置
    ...
    def robot_config_set_gnss_baudrate_req(self, id: str = "") -> tuple[tuple, bytes]:
        """
        配置 GNSS 默认波特率
    ...
    def robot_config_set_gnss_rover_req(self, id: str = "") -> tuple[tuple, bytes]:
        """
        配置 GNSS 为 Rover 模式
    ...
    def robot_config_seterror_req(self, msg: str) -> tuple[tuple, bytes]:
        """
        设置第三方 Error\n
    ...
    def robot_config_setwarning_req(self, msg: str) -> tuple[tuple, bytes]:
        """
        设置第三方 Warning\n
    ...
    def robot_other_play_audio_req(self, name: str, loop: bool = False) -> tuple[tuple, bytes]:
        """
        播放音频, 播放指定的音频文件
    ...
    def robot_other_setdo_req(self, id: int, status: bool) -> tuple[tuple, bytes]:
        """
        设置 DO\n
    ...
    def robot_other_setdos_req(self, dos: list) -> tuple[tuple, bytes]:
        """
        批量设置 DO\n
    ...
    def robot_other_setrelay_req(self, status: bool) -> tuple[tuple, bytes]:
        """
        设置继电器\n
    ...
    def robot_other_softemc_req(self, status: bool) -> tuple[tuple, bytes]:
        """
        软急停\n
    ...
    def robot_other_setchargingrelay_req(self, status: bool) -> tuple[tuple, bytes]:
        """
        设置充电继电器\n
    ...
    def robot_other_pause_audio_req(self) -> tuple[tuple, bytes]:
        """
        暂停播放音频
        """
        return self.request(6010)

    def robot_other_resume_audio_req(self) -> tuple[tuple, bytes]:
        """
        继续播放音频\n
        将从暂停处继续播放
        """
    ...
    def robot_other_stop_audio_req(self) -> tuple[tuple, bytes]:
        """
        停止播放音频\n
        直接结束音频的播放
        """
    ...
    def robot_other_setvdi_req(self, id: int, status: bool) -> tuple[tuple, bytes]:
        """
        设置虚拟 DI\n
    ...
    def robot_other_audio_list_req(self) -> tuple[tuple, bytes]:
        """
        获取音频文件列表
        """
        return self.request(6033)

    def robot_other_set_fork_height_req(self, height: float) -> tuple[tuple, bytes]:
        """
        设置货叉高度\n
    ...
    def robot_other_stop_fork_req(self) -> tuple[tuple, bytes]:
        """
        停止货叉\n
        该 API 用于停止叉车的货叉运动
        """
    ...
    def robot_other_set_fork_forward_req(self, forward: float) -> tuple[tuple, bytes]:
        """
        设置货叉前移后退\n
    ...
    def robot_other_write_peripheral_data_req(self, id: int, data: int) -> tuple[tuple, bytes]:
        """
        写入外设用户自定义数据
    ...
    def robot_other_roller_front_roll_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)向前滚动\n
    ...
    def robot_other_roller_back_roll_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)向后滚动\n
        滚动时两侧挡板均放下,该指令会立即返回, 需通过 1029 或 1100 指令中的 roller_state 来查询滚动是否完成。
        滚动不会因超时而失败，辊筒会一直转动，直到接收新的指令。机器人运动过程中不接受辊筒运动指令
    ...
    def robot_other_roller_left_roll_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)向左滚动\n
        滚动时两侧挡板均放下,该指令会立即返回, 需通过 1029 或 1100 指令中的 roller_state 来查询滚动是否完成。
        滚动不会因超时而失败，辊筒会一直转动，直到接收新的指令。机器人运动过程中不接受辊筒运动指令
    ...
    def robot_other_roller_right_roll_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)向右滚动\n
        滚动时两侧挡板均放下,该指令会立即返回, 需通过 1029 或 1100 指令中的 roller_state 来查询滚动是否完成。
        滚动不会因超时而失败，辊筒会一直转动，直到接收新的指令。机器人运动过程中不接受辊筒运动指令
    ...
    def robot_other_roller_front_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)前上料\n
    ...
    def robot_other_roller_front_unload_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)前下料\n
    ...
    def robot_other_roller_front_pre_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)前预上料\n
    ...
    def robot_other_roller_back_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)后上料\n
    ...
    def robot_other_roller_back_unload_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)后下料\n
    ...
    def robot_other_roller_back_pre_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)后预上料\n
    ...
    def robot_other_roller_left_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)左上料\n
    ...
    def robot_other_roller_left_unload_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)左下料\n
    ...
    def robot_other_roller_right_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)右上料\n
    ...
    def robot_other_roller_right_unload_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)右下料\n
        该指令会立即返回, 需通过 1029 或 1100 指令中的 roller_state 来查询上料是否完成。右上料可能会因超时而失败。
        机器人运动过程中不接受辊筒运动指令
    ...
    def robot_other_roller_left_pre_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)左预上料\n
        该指令会立即返回, 需通过 1029 或 1100 指令中的 roller_state 来查询预上料是否完成。预上料不会因超时而失败，
        辊筒会一直转动，直到接收新的指令。机器人运动过程中不接受辊筒运动指令
    ...
    def robot_other_roller_right_pre_load_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)右预上料\n
        该指令会立即返回, 需通过 1029 或 1100 指令中的 roller_state 来查询预上料是否完成。预上料不会因超时而失败，
        辊筒会一直转动，直到接收新的指令。机器人运动过程中不接受辊筒运动指令
    ...
    def robot_other_roller_stop_req(self) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)停止
        """
        return self.request(6067)

    def robot_other_roller_left_right_inverse_req(self, inverse: bool) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)左右反向\n
    ...
    def robot_other_roller_front_back_inverse_req(self, inverse: bool) -> tuple[tuple, bytes]:
        """
        辊筒(皮带)前后反向\n
    ...
    def robot_other_jack_load_req(self) -> tuple[tuple, bytes]:
        """
        顶升机构上升\n
    ...
    def robot_other_jack_unload_req(self) -> tuple[tuple, bytes]:
        """
        顶升机构下降\n
        该指令会立即返回, 需通过 1027 或 1100 指令中的 jack_state 来查询顶升状态
        """
    ...
    def robot_other_jack_stop_req(self) -> tuple[tuple, bytes]:
        """
        顶升机构停止\n
        该指令会立即返回, 需通过 1027 或 1100 指令中的 jack_state 来查询顶升状态
        """
    ...
    def robot_other_jack_set_height_req(self, height: float) -> tuple[tuple, bytes]:
        """
        顶升调整至固定高度\n
        该指令会立即返回, 需通过 1027 或 1100 指令中的 jack_state 来查询顶升状态
    ...
    def robot_other_reset_cargo_req(self) -> tuple[tuple, bytes]:
        """
        清除载荷状态\n
        该 API 用于清除载荷状态
        """
    ...
    def robot_other_hook_load_req(self) -> tuple[tuple, bytes]:
        """
        牵引上料\n
        后置牵引机构夹取托车
        """
    ...
    def robot_other_hook_unload_req(self) -> tuple[tuple, bytes]:
        """
        牵引下料\n
        后置牵引机构松开托车
        """
    ...
    def robot_other_endslam_req(self) -> tuple[tuple, bytes]:
        """
        停止扫描地图
        """
        return self.request(6101)

    def robot_other_set_motors_req(self) -> tuple[tuple, bytes]:
        """
        电机调试\n
        弃用
        """
    ...
    def robot_other_set_motor_enable_req(self, motor_name: str, enable: bool) -> tuple[tuple, bytes]:
        """
        电机使能与去使能\n
    ...
    def robot_other_clear_goods_req(self, goods_id: str) -> tuple[tuple, bytes]:
        """
        解绑指定货物\n
    ...
    def robot_other_clear_container_req(self, container_name: str) -> tuple[tuple, bytes]:
        """
        从指定料箱解绑货物\n
        此 API 仅对料箱车有效，PS：料箱车指在机器人模型文件中配置了 container 的车,
        有关料箱车 container 详细信息查询可以参考，机器人导航状态或者批量数据1
    ...
    def robot_other_clear_all_containers_goods_req(self) -> tuple[tuple, bytes]:
        """
        从所有料箱解绑货物\n
        此 API 仅对料箱车有效，PS：料箱车指在机器人模型文件中配置了 container 的车,
        有关料箱车 container 详细信息查询可以参考，机器人导航状态或者批量数据1
    ...
    def robot_other_set_container_goods_req(self, goods_id: str, container_name: str, desc: str) -> tuple[tuple, bytes]:
        """
        绑定货物到料箱\n
        此 API 仅对料箱车有效，PS：料箱车指在机器人模型文件中配置了 container 的车,
        有关料箱车 container 详细信息查询可以参考，机器人导航状态或者批量数据1
