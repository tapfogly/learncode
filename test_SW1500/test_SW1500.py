...
def setup_module():
    ...
    with open("config.json", "r") as f:
        ...
        load = body["JackLoad"]
        unload = body["JackUnload"]
    return open_ip, model, s_id, task_id, charger_name, load, unload


ip, model_name, source_id, task, charger, load, unload = setup_module()
